...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('tbl_DentalTreatments', [
      ...
      { specialties_id: 5, name: 'Cirugía Oral', description: 'Extracciones dentarias y cirugía de la boca.', standard_duration: '01:30:00', createdAt: new Date(), updatedAt: new Date() },
